...
$(call inherit-product-if-exists, vendor/lineage/config/altair.mk)
$(call inherit-product-if-exists, vendor/addons/config.mk)

PRODUCT_BRAND ?= Altair ROM
...
LINEAGE_DISPLAY_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(DISPLAY_BUILDTYPE)-$(shell date +%Y%m%d)
LINEAGE_VERSION := Altair-$(LINEAGE_DISPLAY_VERSION)-$(LINEAGE_BUILD)
