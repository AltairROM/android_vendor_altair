#
# Altair ROM Audio Files
#

ALARM_PATH := vendor/altair/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/altair/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/altair/prebuilt/common/media/audio/ringtones
