...
FRAMEWORK_LINEAGE_API_NEEDS_UPDATE_TEXT := $(TOPDIR)vendor/altair/build/core/apicheck_msg_current.txt

# Rules for QCOM targets
include $(TOPDIR)vendor/altair/build/core/qcom_target.mk
